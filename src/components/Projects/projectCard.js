                ...
                `}>
                    ...
                    `}>
                        ...
                        <div className="p-6 overflow-y-auto max-h-[calc(90vh-200px)]">
                            ...
                            {/* Description */}
                            <div className="mb-6">
                                <h3 className={`${spaceGrotesk.className} text-lg font-semibold text-cyan-400 mb-3`}>
                                    Project Overview
                                </h3>
                            ...
                            <div className="mb-6">
                                ...
                                <div className="flex flex-wrap gap-2">
                                    {project.technologies.map((tech, techIndex) => (
                                        <span
                                            key={tech}
                                            className="px-3 py-2 bg-cyan-500/10 border border-cyan-500/30 text-cyan-400 text-sm font-medium rounded transition-all duration-300 hover:bg-cyan-500/20 hover:border-cyan-500/50"
                                        >
                                            {tech}
                                        </span>
                                    ))}
