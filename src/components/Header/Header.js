...
export default function Header() {
    ...
    return (
        <section className="min-h-screen flex flex-col items-center justify-center relative px-4 py-8 md:py-0">
            ...
            {/* ScrollIndicator */}
            <div className="absolute bottom-16 md:bottom-8 left-1/2 transform -translate-x-1/2 z-40">
                <ScrollIndicator />
            </div>

            {/* AnimatedLine bottom */}
            <AnimatedLine
                className="absolute bottom-14 md:bottom-0 left-1/2 transform -translate-x-1/2 z-40"
                delay={1000}
                direction="up"
            />
        </section>
