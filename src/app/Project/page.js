...
const projectsData = [
  ...
  },
  {
    ...
    fullDescription:
      "This project was built for SMA PGRI 1 Gombong, featuring an article management system using Quill Editor and Firebase for storing media and content. The system supports different user roles and is designed as a full-stack solution tailored for educational institutions.",
  ...
  },
  {
    ...
    fullDescription:
      "A modern point-of-sale (POS) web application for small to medium businesses. It includes inventory management, transaction tracking, daily reports, and receipt generation. Built with a REST API backend and a lightweight, responsive frontend.",
  ...
  },
  {
    ...
    fullDescription:
      "This project utilizes Jupyter Notebook to implement decision tree models for various regression and classification tasks. It focuses on optimizing system performance and tuning parameters to reduce runtime. A good showcase of basic machine learning and analytics skills.",
  ...
  },
  {
    ...
    fullDescription:
      "A clean and professional portfolio website featuring a dynamic project showcase using modal windows. Built with Next.js and Tailwind CSS, this site is SEO-optimized and responsive, perfect for presenting projects to clients and recruiters.",
  ...
  },
  {
    ...
    fullDescription:
      "This project models Wi-Fi user behavior on a campus network using CLI scripts and Google Colab. It visualizes user distribution and network load to help analyze system bottlenecks using probability-based simulations.",
  ...
  },
  {
    ...
    fullDescription:
      "This project is a learning exercise focused on implementing and consuming REST APIs using Next.js. It features modern fetch patterns, modular components, and integration best practices.",
  ...
  },
  {
    ...
    fullDescription:
      "Built with basic HTML and CSS, this website was designed to introduce college departments and student life to high school students at SMALSA. A static promotional site created independently as part of a student initiative.",
  ...
  },
  {
    ...
    fullDescription:
      "This project was meant for a hackathon but wasn't completed due to time constraints. It contains initial layout and UI components built with React and Tailwind CSS.",
    ...
    <>
        ...
        <div className="relative w-full h-40 sm:h-48 lg:h-64 bg-gradient-to-br from-zinc-800 to-zinc-700 flex items-center justify-center overflow-hidden">
          <div className="relative w-full h-full">
            ...
            <div className="absolute inset-0 hidden items-center justify-center">
              <span className="font-mono text-slate-500 text-lg">
                [PROJECT SCREENSHOT]
              </span>
            </div>
          </div>
          ...
          <div className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
            <div className="text-center">
              <div
                className={`${spaceGrotesk.className} text-cyan-400 font-semibold text-lg uppercase tracking-wide mb-2`}>
                View Details
              </div>
      ...
      {isModalOpen && (
        <div
          ...
          <div
            className={`relative bg-zinc-900/95 border border-cyan-400/20 rounded-lg max-w-4xl w-full max-h-[90vh] overflow-hidden transition-all duration-300 ease-out ${
              modalVisible
            ...
            <div className="flex justify-between items-center p-4 sm:p-6 border-b border-cyan-400/20">
              <div>
                <h2
                  className={`${spaceGrotesk.className} text-xl sm:text-2xl font-bold text-cyan-400 mb-2`}>
                  {project.title}
                </h2>
                <div
            ...
            <div className="p-4 sm:p-6 overflow-y-auto max-h-[calc(90vh-200px)]">
              <div className="relative w-full h-48 sm:h-64 bg-gradient-to-br from-zinc-800 to-zinc-700 rounded-lg mb-6 flex items-center justify-center overflow-hidden">
                <div className="relative w-full h-full">
                  ...
                  />
                  <div className="absolute inset-0 hidden items-center justify-center">
                    <span className="font-mono text-slate-500 text-xl">
                      [PROJECT PREVIEW]
                    </span>
                  </div>
                </div>
              ...
              <div className="mb-6">
                <h3
                  className={`${spaceGrotesk.className} text-base sm:text-lg font-semibold text-cyan-400 mb-3`}>
                  Project Overview
                </h3>
              ...
              <div className="mb-6">
                ...
                <div className="flex flex-wrap gap-2">
                  {project.technologies.map((tech) => (
                    <span
                      key={tech}
                      className="px-2 py-1 sm:px-3 sm:py-2 bg-cyan-500/10 border border-cyan-500/30 text-cyan-400 text-xs sm:text-sm font-medium rounded transition-all duration-300 hover:bg-cyan-500/20 hover:border-cyan-500/50">
                      {tech}
                    </span>
                  ))}
                </div>
  ...
  if (!mounted) {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-900 via-slate-800 to-slate-900 text-white">
        ...
        <ThemeToggle />
        <div
          className={`container mx-auto px-4 sm:px-6 py-20 relative z-10 ${spaceGrotesk.className}`}>
          <h2
            className={`${orbitron.className} text-3xl sm:text-4xl font-bold text-cyan-400 mb-6`}>
            Projects
          </h2>
          <p className={`text-slate-300 mb-8 ${spaceGrotesk.className}`}>
            Here are some of the projects I have worked on, spanning a variety
            of technologies and approaches.
          </p>
          <div className="relative mb-20" id="projects">
            <div
              className={`grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-10 ${spaceGrotesk.className}`}>
              {/* Loading placeholder */}
              {Array.from({ length: 4 }).map((_, index) => (
                <div
                  key={index}
                  className="max-w-2xl w-full mx-auto h-96 bg-zinc-900/50 animate-pulse rounded-lg"
                />
              ))}
            </div>
          </div>
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-slate-800 to-slate-900 text-white">
      ...
      <div
        ...
        <h2
          className={`${
            orbitron.className
          } text-3xl sm:text-4xl font-bold text-cyan-400 mb-6 transition-all duration-700 ${
            shouldShow ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
          }`}>
          Projects
        </h2>
        <p
          className={`text-slate-300 mb-8 transition-all duration-700 delay-200 ${
            shouldShow ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
          }`}>
          Here are some of the projects I have worked on, spanning a variety of
